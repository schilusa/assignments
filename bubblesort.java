...
public class bubblesort {
    public static void main(String args[]) {
        ...
        System.out.println("enter first student maths marks");
        m1 = s.nextInt();
        System.out.println("enter first student history marks subject marks");
        h1 = s.nextInt();
        System.out.println("enter firststudent chemistry marks subject marks");
        c1 = s.nextInt();
        ...
        a1 = (m1 + h1 + c1) / 3;
        System.out.println("first student avarage marks" + a1);
        a2 = (m2 + h2 + c2) / 3;
        ...
        sa2 = (h1 + h2 + h3) / 3;
        System.out.println("history avarage marks" + sa2);
        sa3 = (c1 + c2 + c3) / 3;
        System.out.println("maths total marks" + sa3);
    }
}
